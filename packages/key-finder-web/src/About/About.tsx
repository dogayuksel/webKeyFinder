...
class About extends Component {
  componentDidMount() {
    ...
    document.querySelector('meta[name="description"]').setAttribute("content", "Find out more about how the Key Finder Application application works. Access the source code to run it yourself.");
  }
    ...
    return (
      <main class="about-page">
        ...
        <div class="about-page__links">
          ...
          <p>Source code is available on <GithubLink />.</p>

...
const keysNotation = (customSettings && customSettings.keysNotation) ? customSettings.keysNotation : defaultKeysNotation;

const defaultTheme = 'light';
const theme = (customSettings && customSettings.theme) ? customSettings.theme : defaultTheme;

const defaultKeyAtTopPosition = "C Major";
const keyAtTopPosition = (customSettings && customSettings.keyAtTopPosition)
